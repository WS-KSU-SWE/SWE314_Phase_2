...
public class Controller {
	...
	public Controller() {
		...
		employees = new DoubleLinkedList<Employee>();
		customers = new DoubleLinkedList<Customer>();
		accounts = new DoubleLinkedList<Account>();
		
	}
	
	
	public boolean authenticateCallerStatusForViewingCurrentData(Object caller, int customerId) {
		...
		if (caller instanceof Customer) {
			
			Customer customer = (Customer) caller;
	...
	public boolean authenticateCallerStatusForViewingAllData(Object caller, int customerId) {
		
		if (caller instanceof Employee) {
			
			Employee employee = (Employee) caller;
			
			
			if (employee.getPosition() == Position.Cerk) {
				return false;
			}
	...
	public boolean authenticateCallerStatusForModifying(Object caller, int customerId) {
	...
	public long generateRandomKey() {
		...
		return key.nextLong(); // generates a random block of 64-bits
	}
	 ...
	 */
	public String decrypt(String plaintext, long key) {
